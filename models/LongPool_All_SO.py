# 下采样过程，三次下采样，全部使用长条池化，池化核为（4,2,2），并添加侧输出（SideOutput，SO）
...
class LongPool_All_SO(nn.Module):
    """
    ...
    def __init__(self, in_channels, out_channels):
        super(LongPool_All_SO, self).__init__()
...
if __name__ == '__main__':
    model = LongPool_All_SO(3, 2).to('cuda:0')
    summary(model, (3, 128, 128, 128))
# ================================================================
# Total params: 5,826,362
# Trainable params: 5,826,362
# Non-trainable params: 0
# ----------------------------------------------------------------
# Input size (MB): 24.00
# Forward/backward pass size (MB): 9406.63
# Params size (MB): 22.23
# Estimated Total Size (MB): 9452.86
# ----------------------------------------------------------------
