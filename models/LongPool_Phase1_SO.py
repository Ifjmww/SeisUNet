# 下采样过程，第一次下采样使用长条池化，池化核为（4,2,2），其余后两次下采样使用最大池化，并添加侧输出（SideOutput，SO）
...
class LongPool_Phase1_SO(nn.Module):
    """
    ...
    def __init__(self, in_channels, out_channels):
        super(LongPool_Phase1_SO, self).__init__()
...
if __name__ == '__main__':
    model = LongPool_Phase1_SO(3, 2).to('cuda:0')
